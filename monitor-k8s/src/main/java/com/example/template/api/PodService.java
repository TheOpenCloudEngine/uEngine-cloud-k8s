...
public class PodService  {
	...
	public void getDesc(String kubehost, String kubetoken, String namespace, String name) {
		ApiClient client = Config.fromToken(kubehost, kubetoken, false);
		CoreV1Api api = new CoreV1Api(client);

		String containerName = "";
		try {
			V1PodTemplate v1pod = api.readNamespacedPodTemplate(name, namespace, "true", false, false);
